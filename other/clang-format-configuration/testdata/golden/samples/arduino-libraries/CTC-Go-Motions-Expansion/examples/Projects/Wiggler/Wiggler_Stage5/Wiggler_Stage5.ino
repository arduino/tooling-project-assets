...
void loop() {
  ...
  delay(15);
  if (lightValue_1 >= 900) { /*servo_drive.write(60);    servo_steer.write(30);    delay(3000); */
    ____________(right);
  }
  if (lightValue_2 >= 900) { /*servo_drive.write(60);    servo_steer.write(150);    delay(3000); */
    ____________(left);
  }
  if (lightValue_1 <= 50 && lightValue_2 <= 50) { ____________(); }
  delay(100);
}
