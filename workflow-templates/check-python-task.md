...
```
poetry init --python="^3.9" --dev-dependency="black@^23.7.0" --dev-dependency="flake8@^6.1.0" --dev-dependency="pep8-naming@^0.13.3"
poetry install
```
...
```
poetry add --dev "black@^23.7.0" "flake8@^6.1.0" "pep8-naming@^0.13.3"
```
