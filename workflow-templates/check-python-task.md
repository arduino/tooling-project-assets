...
```
poetry init --python="^3.9" --dev-dependency="black@^24.4.2" --dev-dependency="flake8@^7.0.0" --dev-dependency="pep8-naming@^0.14.1"
poetry install
```
...
```
poetry add --dev "black@^24.4.2" "flake8@^7.0.0" "pep8-naming@^0.14.1"
```
