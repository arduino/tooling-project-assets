...
```
poetry init --python="^3.9" --dev-dependency="black@^24.8.0" --dev-dependency="flake8@^7.1.1" --dev-dependency="pep8-naming@^0.14.1"
poetry install
```
...
```
poetry add --dev "black@^24.8.0" "flake8@^7.1.1" "pep8-naming@^0.14.1"
```
