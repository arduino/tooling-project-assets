...
```
poetry init --python="^3.9" --dev-dependency="black@^22.8" --dev-dependency="flake8@^5.0.4" --dev-dependency="pep8-naming@^0.13.2"
poetry install
```
...
```
poetry add --dev "black@^22.8" "flake8@^5.0.4" "pep8-naming@^0.13.2"
```
